...
---
name: documentacion
description: "Auto-skill for documentation updates — CHANGELOG, architecture docs, ADRs"
...
3. NEVER skip documentation — it is a mandatory part of every change
