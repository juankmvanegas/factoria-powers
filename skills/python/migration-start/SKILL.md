...
Capture all constraints and characteristics of the source system before starting a migration to Python/FastAPI with Clean Architecture. This is Phase 0 of the migration workflow — no code is written, only analysis.
...
1. **Detect source framework** — Scan the project root for:
...
5. **Assess business rules complexity** — Evaluate:
...
6. **Generate constraints document** — Write to `.cloud/planning/migration-constraints.md`:
...
- This skill is READ-ONLY — no code changes
