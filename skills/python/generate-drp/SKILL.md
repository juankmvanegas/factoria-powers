...
1. **Domain first** â€” Entities, value objects, domain events
2. **Application second** â€” Use cases, DTOs, port interfaces
3. **Infrastructure third** â€” Repository implementations, adapters
4. **Presentation last** â€” API endpoints, middleware
...
- Keep steps atomic â€” each step should be completable independently
