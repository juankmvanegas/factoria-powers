...
```
[YYYY-MM-DD HH:mm] GATE: {gate_name} â€” {PASS|FAIL}
...
## Timeline
- [HH:mm] Started â€” {initial context}
- [HH:mm] Decision â€” {what was decided}
- [HH:mm] Gate â€” {gate result}
- [HH:mm] Created â€” {file}
- [HH:mm] Completed â€” {summary}
...
```
.cloud/audit/
  decisions.log      â€” Architectural decisions (append-only)
  gates.log          â€” Approval gate results (append-only)
  changes.log        â€” File change tracking (append-only)
  sessions/          â€” Per-session timelines
...
- Audit logs are **append-only** â€” NEVER modify or delete existing entries
- EVERY significant action MUST be recorded â€” no silent changes
