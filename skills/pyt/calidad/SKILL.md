...
Structure the sections with spacing, helper methods, and variable naming. Do **not** add source-code comments only to label AAA blocks.
...
- Sonar-aligned code rules are mandatory: cyclomatic complexity < 10, cognitive complexity < 15, no commented-out code, and no routine source-code comments added to explain obvious logic
