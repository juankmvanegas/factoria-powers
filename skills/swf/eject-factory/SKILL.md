...
- Glob `references/swf/policies/*.md` → copy each to `.factory/policies/`
- Glob `references/swf/adrs/*.md` → copy each to `.factory/adrs/`
- Read `references/swf/CLAUDE.md` → Write to `.factory/CLAUDE.md`
...
- Add at the top: `# Standalone Project (Ejected from Factoria-Swf)`
