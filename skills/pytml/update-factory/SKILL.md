...
Update the Factoria installation in the project when a new version is available. Merge new skills, policies, and patterns while preserving the project's custom modifications.
...
2. Propose merge preserving custom sections
